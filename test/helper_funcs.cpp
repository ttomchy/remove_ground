...
Cloud::Ptr MoveAlongY(Cloud::Ptr cloud, double dist) {// move along Y 
...
Cloud::Ptr RotateAroundZ(Cloud::Ptr cloud, Radians angle) { // rotated along z 
  // rotate around z axis  沿着Z 轴进行旋转。
